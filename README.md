...
- [jolokia-mcp-server-0.5.1-runner.jar](https://github.com/jolokia/jolokia-mcp-server/releases/download/v0.5.1/jolokia-mcp-server-0.5.1-runner.jar)
...
- [jolokia-mcp-agent-jvm-0.5.1-javaagent.jar](https://github.com/jolokia/jolokia-mcp-server/releases/download/v0.5.1/jolokia-mcp-agent-jvm-0.5.1-javaagent.jar)
